...
//
// "How am I doing this month?" Personal budgets for the authenticated user.
// Backend route: GET /api/budgets
...
export const getBudgetStatus = {
  ...
  description:
    "Show the user's personal budget vs actual spend for the current month " +
    "(or a specified month). Use this when the user asks 'how am I doing', " +
    "'am I over budget', 'which categories am I over on', or similar. " +
    "For business-entity P&L, call get_pnl instead.",
  ...
  inputSchema: {
    ...
    properties: {
      month: {
        type: "string",
        description: "Month to report on, YYYY-MM. Defaults to current month.",
        pattern: "^\\d{4}-\\d{2}$",
      },
    },
